...
- `plans/complete/` — historical reference
  ...
  - [2026-04-cross-lead-workflows](plans/complete/2026-04-cross-lead-workflows/tracker.md) — Phase 1 shipped: `_Shared/` Obsidian dropbox mounted RW into every working-group container at `/workspace/extra/shared/`; agents coordinate via file-mailbox pattern. Phase 2/3 (mailroom routing, scoped inbox MCP) deferred — `forward_to_group` MCP attempt reverted after fighting Telegram bot-to-bot filtering and layered authorization. See `lode/lessons.md`.
